...
# --- Run tests and produce JUnit XML (timeout after 2min to catch hangs; flaky tests don't block) ---
echo "Running tests..."
timeout 120 ctest --test-dir build --output-on-failure --output-junit test-report.xml || true
